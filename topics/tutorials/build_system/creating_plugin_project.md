...
> New plugin projects should be implemented in a way that supports working in Remote Development mode or so-called [Split Mode](split_mode_and_remote_development.md).
> Review [](split_mode_and_remote_development.md) before settling on module boundaries.
>
